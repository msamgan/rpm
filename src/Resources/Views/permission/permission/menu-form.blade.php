            ...
            <form id="menu-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="route" aria-describedby="routeHelp"
                               required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="icon" aria-describedby="iconHelp"
